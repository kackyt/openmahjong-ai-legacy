========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MahjongAITestGUI
========================================================================


AppWizard が生成した MahjongAITestGUI には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには MahjongAITestGUI を構成している各ファイルの概要説明が含まれています。

MahjongAITestGUI.dsp
...
MahjongAITestGUI.h
    ...
    みます） をインクルードし、また CMahjongAITestGUIApp アプリケーションクラスを宣
    言します。

MahjongAITestGUI.cpp
    このファイルは CMahjongAITestGUIApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\MahjongAITestGUI.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル MahjongAITestGUI.rc によってインクルード
    されます。

res\MahjongAITestGUI.rc2
...
MahjongAITestGUIDlg.h, MahjongAITestGUIDlg.cpp - ダイアログ
    これらのファイルは CMahjongAITestGUIDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な MahjongAITestGUI.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MahjongAITestGUI.pch 
